cdef extern from "distances_core.h":
	...
	void distance_from_points(inum npix, double * posmap, inum npoint, double * points, double * dists, int * area)
	void distance_from_points_separable(inum ny, inum nx, double * ypos, double * xpos, inum npoint, double * points, double * dists, int * area)
