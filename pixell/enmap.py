...
class ndmap(np.ndarray):
	...
	def resample(self, oshape, off=(0,0), method="fft", mode="wrap", corner=False, order=3): return resample(self, oshape=oshape, off=off, method=method, mode=mode, corner=corner, order=order)
