...
enmap.write_map("data/MM_offset_obs_pos_042219.fits",obs_pos)
enmap.write_map("data/MM_offset_grad_042219.fits",grad)
enmap.write_map("data/MM_offset_raw_pos_042219.fits",raw_pos)
